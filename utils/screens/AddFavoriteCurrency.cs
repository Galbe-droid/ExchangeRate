...
{
    internal class AddFavoriteCurrency
    {
        ...
        public static User Menu(User user, List<CurrencyWithName> currencies)
        {
            ...
            do
            {
                    ...
                    if (choose == 1)
                    {
                        ...
                        do
                        {
                            ...
                            if (choiceCurrency.Length >= 3)
                            {
                                ...
                                //Adds the favorite currencies inside the user 
                                user.FavoriteCurrencyCode.AddRange(currencySeparated);
                ...
                //If user choose 3 it exit the loop returning the user with his coosen currencies as favorites
            } while (choose != 3);
            return user;
        }
    }
